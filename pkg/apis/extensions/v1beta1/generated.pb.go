...
func (m *NetworkPolicySource) Reset()         { *m = NetworkPolicySource{} }
func (m *NetworkPolicySource) String() string { return proto.CompactTextString(m) }
func (*NetworkPolicySource) ProtoMessage()    {}
...
func init() {
	...
	proto.RegisterType((*NetworkPolicySource)(nil), "k8s.io.kubernetes.pkg.apis.extensions.v1beta1.NetworkPolicySource")
...
func (m *NetworkPolicySource) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *NetworkPolicySource) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Pods != nil {
		...
		n50, err := m.Pods.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n50
	...
	if m.Namespaces != nil {
		...
		n51, err := m.Namespaces.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *ReplicaSetSpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintGenerated(data, i, uint64(m.Template.Size()))
	n63, err := m.Template.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n63
...
func (m *RollingUpdateDeployment) MarshalTo(data []byte) (int, error) {
	...
	if m.MaxUnavailable != nil {
		...
		n64, err := m.MaxUnavailable.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n64
	...
	if m.MaxSurge != nil {
		...
		n65, err := m.MaxSurge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *SELinuxStrategyOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.SELinuxOptions != nil {
		...
		n66, err := m.SELinuxOptions.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *NetworkPolicySource) Size() (n int) {
	var l int
	_ = l
	if m.Pods != nil {
		l = m.Pods.Size()
...
func (m *NetworkPolicyIngressRule) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.From = append(m.From, NetworkPolicySource{})
...
func (m *NetworkPolicyPort) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Protocol = k8s_io_kubernetes_pkg_api_v1.Protocol(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *NetworkPolicySource) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NetworkPolicySource: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NetworkPolicySource: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
