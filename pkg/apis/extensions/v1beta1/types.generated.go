			...
			if yyr2 || yy2arr2 {
				...
				if x.Items == nil {
					...
					if false {
						...
						h.encSliceNetworkPolicyList(([]NetworkPolicyList)(x.Items), e)
					}
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
		...
		case "items":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceNetworkPolicyList((*[]NetworkPolicyList)(yyv6), d)
				}
			}
		case "kind":
			if r.TryDecodeAsNil() {
...
func (x *NetworkPolicyList) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceNetworkPolicyList((*[]NetworkPolicyList)(yyv13), d)
		}
	}
	yyj10++
	if yyhl10 {
				...
				if yyq2[1] {
					if x.From == nil {
						...
						if false {
							...
							h.encSliceNetworkPolicySource(([]NetworkPolicySource)(x.From), e)
						}
					}
				} else {
					r.EncodeNil()
		...
		case "from":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceNetworkPolicySource((*[]NetworkPolicySource)(yyv6), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *NetworkPolicyIngressRule) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceNetworkPolicySource((*[]NetworkPolicySource)(yyv11), d)
		}
	}
	for {
		yyj8++
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "protocol":
			if r.TryDecodeAsNil() {
				...
				x.Protocol = pkg2_v1.Protocol(r.DecodeString())
			}
		case "port":
			if r.TryDecodeAsNil() {
				if x.Port != nil {
				...
				if x.Port == nil {
					x.Port = new(pkg6_intstr.IntOrString)
				}
				yym6 := z.DecBinary()
				_ = yym6
				if false {
...
func (x *NetworkPolicySource) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					if x.Pods == nil {
						...
						_ = yym4
						if false {
						} else if z.HasExtensions() && z.EncExt(x.Pods) {
						} else {
							z.EncFallback(x.Pods)
						}
					}
				} else {
					r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					if x.Namespaces == nil {
						...
						_ = yym7
						if false {
						} else if z.HasExtensions() && z.EncExt(x.Namespaces) {
						} else {
							z.EncFallback(x.Namespaces)
						}
					}
				} else {
					r.EncodeNil()
...
func (x *NetworkPolicySource) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *NetworkPolicySource) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "pods":
			if r.TryDecodeAsNil() {
				...
				if x.Pods == nil {
					x.Pods = new(pkg1_unversioned.LabelSelector)
				}
				yym5 := z.DecBinary()
				_ = yym5
				if false {
				} else if z.HasExtensions() && z.DecExt(x.Pods) {
				} else {
					z.DecFallback(x.Pods, false)
				}
			}
		case "namespaces":
			if r.TryDecodeAsNil() {
				...
				if x.Namespaces == nil {
					x.Namespaces = new(pkg1_unversioned.LabelSelector)
				}
				yym7 := z.DecBinary()
				_ = yym7
				if false {
				} else if z.HasExtensions() && z.DecExt(x.Namespaces) {
				} else {
					z.DecFallback(x.Namespaces, false)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *NetworkPolicySource) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj8 int
...
func (x codecSelfer1234) encSliceNetworkPolicyList(v []NetworkPolicyList, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decSliceNetworkPolicyList(v *[]NetworkPolicyList, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == 0 {
		...
		if yyl1 > cap(yyv1) {
			...
			if yyrt1 {
				if yyrl1 <= cap(yyv1) {
					...
					yyv1 = make([]NetworkPolicyList, yyrl1)
				}
			} else {
				yyv1 = make([]NetworkPolicyList, yyrl1)
			}
		...
		if yyrt1 {
			for ; yyj1 < yyl1; yyj1++ {
				yyv1 = append(yyv1, NetworkPolicyList{})
				yyh1.ElemContainerState(yyj1)
				if r.TryDecodeAsNil() {
					yyv1[yyj1] = NetworkPolicyList{}
				} else {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, NetworkPolicyList{}) // var yyz1 NetworkPolicyList
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
...
func (x codecSelfer1234) encSliceNetworkPolicySource(v []NetworkPolicySource, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decSliceNetworkPolicySource(v *[]NetworkPolicySource, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyl1 == 0 {
		...
		if yyl1 > cap(yyv1) {
			...
			if yyrt1 {
				if yyrl1 <= cap(yyv1) {
					...
					yyv1 = make([]NetworkPolicySource, yyrl1)
				}
			} else {
				yyv1 = make([]NetworkPolicySource, yyrl1)
			}
		...
		if yyrt1 {
			for ; yyj1 < yyl1; yyj1++ {
				yyv1 = append(yyv1, NetworkPolicySource{})
				yyh1.ElemContainerState(yyj1)
				if r.TryDecodeAsNil() {
					yyv1[yyj1] = NetworkPolicySource{}
				} else {
		...
		for ; !r.CheckBreak(); yyj1++ {
			...
			if yyj1 >= len(yyv1) {
				yyv1 = append(yyv1, NetworkPolicySource{}) // var yyz1 NetworkPolicySource
				yyc1 = true
			}
			yyh1.ElemContainerState(yyj1)
			if yyj1 < len(yyv1) {
