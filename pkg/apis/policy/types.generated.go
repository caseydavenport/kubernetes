...
func (x *NetworkPolicySpec) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "podSelector":
			if r.TryDecodeAsNil() {
				x.PodSelector = pkg2_unversioned.LabelSelector{}
			} else {
				yyv4 := &x.PodSelector
				yym5 := z.DecBinary()
				_ = yym5
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "protocol":
			if r.TryDecodeAsNil() {
				...
				if x.Protocol == nil {
					x.Protocol = new(pkg3_api.Protocol)
				}
		...
		case "port":
			if r.TryDecodeAsNil() {
				...
				if x.Port == nil {
					x.Port = new(pkg1_intstr.IntOrString)
				}
				yym6 := z.DecBinary()
				_ = yym6
				if false {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "pods":
			if r.TryDecodeAsNil() {
				...
				if x.Pods == nil {
					x.Pods = new(pkg2_unversioned.LabelSelector)
				}
				yym5 := z.DecBinary()
				_ = yym5
				if false {
		...
		case "namespaces":
			if r.TryDecodeAsNil() {
				...
				if x.Namespaces == nil {
					x.Namespaces = new(pkg2_unversioned.LabelSelector)
				}
				yym7 := z.DecBinary()
				_ = yym7
				if false {
