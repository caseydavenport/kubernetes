...
func NewREST(opts generic.RESTOptions) *REST {
	...
	newListFunc := func() runtime.Object { return &policyapi.NetworkPolicyList{} }
	storageInterface := opts.Decorator(
		opts.Storage, cachesize.GetWatchCacheSizeByResource(cachesize.NetworkPolicys), &policyapi.NetworkPolicy{}, prefix, networkpolicy.Strategy, newListFunc)

	store := &registry.Store{
		NewFunc: func() runtime.Object { return &policyapi.NetworkPolicy{} },
		...
		ObjectNameFunc: func(obj runtime.Object) (string, error) {
			return obj.(*policyapi.NetworkPolicy).Name, nil
		},
		// Used to match objects based on labels/fields for list and watch
		PredicateFunc: func(label labels.Selector, field fields.Selector) generic.Matcher {
			return networkpolicy.MatchNetworkPolicy(label, field)
		},
		QualifiedResource:       policyapi.Resource("networkpolicys"),
